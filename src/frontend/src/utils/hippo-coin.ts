const HIPPO_COINS = [
  {
    ...
    token_type: {
      type: "0xc0de11113b427d35ece1d8991865a941c0578b0f349acabbe9753863c24109ff::example_apt::ExampleAPT",
      account_address:
  ...
  },
  {
    ...
    project_url: "https://aptoslabs.com/",
    token_type: {
      type: "0xc0de11113b427d35ece1d8991865a941c0578b0f349acabbe9753863c24109ff::example_usdc::ExampleUSDC",
      account_address:
        "0xc0de11113b427d35ece1d8991865a941c0578b0f349acabbe9753863c24109ff",
...
export function getTokenInfo(coinType: string) {
  return HIPPO_COINS.find((item) => item.token_type.type === coinType);
}
